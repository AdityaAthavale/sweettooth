...
export default function HtmlForm(props) {
    console.log(props.context.state.deliveryDate)
    return(
                ...
                context => {
                    return(<form method="post">
                        ...
                        <div className="row form-group">
                            ...
                            <div className="col-md-8">
                                <DatePicker selected={context.state.deliveryDate} onChange={context.handleDateChange} />
                                {/* <DatePicker id="example-datepicker" value={props.context.state.deliveryDate}
                                onChange={props.context.handleDateChange}/> */}
                            </div>
                        </div>
                        <div className="row form-group">
                            <div className="col-md-4">
